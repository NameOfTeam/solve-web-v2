...
const ContestCard = ({ data }: { data: Contest }) => {
  ...
  return (
    <Link href={`/contests/${data.id}`} className="w-full h-64 px-7 py-9 relative flex flex-col justify-between border border-bg-border bg-container rounded-lg cursor-pointer text-main-container">
