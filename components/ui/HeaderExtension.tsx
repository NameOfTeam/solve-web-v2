...
const HeaderExtension = () => {
  return (
    <div className="header-extension w-[560px] bg-container border-bg-border border border-t-2 border-t-primary-700 absolute top-[72px] z-[999999] hidden origin-top-left hover:flex justify-between">
      ...
      <div className="flex flex-col gap-y-3 flex-1 border-r border-bg-border px-3 py-4">
        ...
        <Link href="/official-contests" className="hover:text-white text-sm">
          공식 대회
        </Link>
