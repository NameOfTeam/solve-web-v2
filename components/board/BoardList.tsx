          ...
          {boards && boards.content.length > 0 ? (
            boards.content.map((item, idx) => (
              ...
              >
                ...
                <p className="flex-[6] px-4 text-main-container">
                  {item.title}
                </p>
                <p className="flex-[1.3] px-4 text-center">{item.language}</p>
                <p className="flex-[1.3] px-4 text-center">
            ...
            <div className="w-full h-72 flex items-center justify-center">
              <p className="text-2xl text-bg-border">등록된 게시글이 없습니다.</p>
            </div>
          )}
        </div>
      </div>
